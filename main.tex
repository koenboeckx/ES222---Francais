...
\input{0b-circuit_theory}
\part{Components}
\input{1-semiconductors}
\input{1b-pn-junction}
\input{1c-transistors}
\part{Analog Electronics}
\input{2-analog}
\input{2b-amplifiers}
\input{3-highfreq}
%\input{4-advancedanalog}
\input{4a-power_amplifiers}
\input{4b-feedback}
\input{4c-oscillators}
\input{4d-dc_generators}
\part{Digital Electronics}
\input{5-digital}
\input{6-advanceddigital}
\input{8-converters}
